      ...
      <ul class="tableft__list--options">
        ...
        <li class="tableft--option manage--option">
          ...
          <ul class="tableft__manage--options">
            ...
            <nuxt-link to="/citizen/family" v-show="role === 'citizen'" class="link">
              <li>Thông tin nhân thân</li>
            </nuxt-link>
            <nuxt-link to="/citizen/listInforPoli" v-show="role === 'citizen'" class="link">
        ...
        <li class="tableft--option manage--option" v-show="role !== 'citizen'">
          ...
          <ul class="tableft__manage--options">
            <li @click.prevent="addAccount">Thêm tài khoản</li>
        ...
        <li class="tableft--option" v-show="role !== 'admin'">
          ...
          <nuxt-link
            to="/citizen/appointments/_appointments"
            v-show="role === 'citizen'"
            class="link"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <li class="tableft--option" v-show="role === 'citizen'">
          <nuxt-link to="/citizen/opinions" class="link">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path
